...
*   **📦 إدارة البيانات:** تسجيل ومتابعة كاملة للإيرادات والمصاريف مع إمكانية إرفاق صور الإيصالات (JPG, PNG) ومعاينتها.
*   **🖼️ معالجة الصور:** توليد تلقائي للصور المصغرة (Thumbnails) لضمان سرعة تصفح سجلات المصروفات.
